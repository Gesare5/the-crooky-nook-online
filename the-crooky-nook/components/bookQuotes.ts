const quotes = [
    ...
    {
        id: 11,
        quote: "A childhood without books - that would be no childhood. That would be like being shut out from the enchanted place where you can go and find the rarest kind of joy.",
